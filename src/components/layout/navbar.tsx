...
export function Navbar({ user }: NavbarProps) {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full bg-[#14532d] border-b border-white/10">
            ...
            {user ? (
              ...
              <>
                ...
                <Link href="/professionals/register">
                  <Button size="sm" variant="outline" className="h-9 bg-transparent border-white/30 text-white hover:border-white/60 hover:bg-white/10 hover:text-white text-sm font-medium">
