...
import { LayoutDashboard, User, FileText, Sparkles, Star, Shield, LogOut, ChevronDown } from "lucide-react";
...
export function UserDropdown({ displayName, isAdmin, isProfessional }: Props) {
