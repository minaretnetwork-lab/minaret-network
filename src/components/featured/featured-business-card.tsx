...
export function FeaturedBusinessCard({ listing }: { listing: FeaturedCardData }) {
  ...
  const heroImage = professional.logoUrl || photoUrl;
  const heroIsLogo = !!professional.logoUrl;
      ...
      <div className="relative w-full h-44">
        ...
        <div className="absolute top-2.5 left-2.5 right-2.5 flex items-start justify-between pointer-events-none">
          ...
          {isMosqueAffiliated && professional.mosque && (
            <span className="inline-flex items-center gap-1 text-[10px] text-emerald-600 dark:text-emerald-400 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm border border-emerald-100 dark:border-emerald-800/40 px-2 py-0.5 rounded-full shadow-sm">
